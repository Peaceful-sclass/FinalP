		...
		<div class="container">
			<div class="row inner-menu-box">
						...
						<div class="cat-area">
							<div id="cat-list1" class="cat-list" style="display: block;">
								...
								<ul class="cat">
									...
									<li><a href="fieldlist.do?category='기획/아이디어'" class="1">기획/아이디어</a></li>
									<li><a href="fieldlist.do?category='광고/마케팅'" class="1">광고/마케팅</a></li>
									<li><a href="fieldlist.do?category='논문/리포트'" class="1">논문/리포트</a></li>
									<li><a href="fieldlist.do?category='영상/UCC/사진'" class="1">영상/UCC/사진</a></li>
									<li><a href="fieldlist.do?category='디자인/캐릭터/웹툰'" class="1">디자인/캐릭터/웹툰</a></li>
									<li><a href="fieldlist.do?category='웹/모바일/플래시'" class="1">웹/모바일/플래시</a></li>
									<li><a href="fieldlist.do?category='게임/소프트웨어'" class="1">게임/소프트웨어</a></li>
									<li><a href="fieldlist.do?category='과학/공학'" class="1">과학/공학</a></li>
									<li><a href="fieldlist.do?category='문학/글/시나리오'" class="1">문학/글/시나리오</a></li>
									<li><a href="fieldlist.do?category='건축/건설/인테리어'" class="1">건축/건설/인테리어</a></li>
									<li><a href="fieldlist.do?category='네이밍/슬로건'" class="1">네이밍/슬로건</a></li>
									<li><a href="fieldlist.do?category='예체능/미술/음악'" class="1">예체능/미술/음악</a></li>
									<li><a href="fieldlist.do?category='대외활동/서포터즈'" class="1">대외활동/서포터즈</a></li>
									<li><a href="fieldlist.do?category='봉사활동'" class="1">봉사활동</a></li>
									<li><a href="fieldlist.do?category='취업/창업'" class="1">취업/창업</a></li>
									<li><a href="fieldlist.do?category='해외'" class="1">해외</a></li>
									<li><a href="fieldlist.do?category='기타'" class="1">기타</a></li>
								</ul>
				...
				<div class="col-9">					
					...
					<div class="ms-menu">
						<button class="btn btn-primary" onclick="ctinsertform();">공모전 등록하기</button>
						<script type="text/javascript">

						function ctinsertform() {
							let login = "${member.member_id}";
							if(login == null || login == "" || login == undefined){
								toastr.warning("로그인이 필요합니다.", "로그인",{tiemOut:5000});
							}else{
								location.href='contestinsert.do';
							}
					 	}
						</script>
					</div>
