...
CREATE table contest(
    ...
    CONTESTNAME VARCHAR2(1000) NOT NULL,
...
ALTER TABLE CONTEST MODIFY(CONTESTFIELD VARCHAR2(1000));
ALTER TABLE CONTEST MODIFY(CONTESUPPORT VARCHAR2(1000));
ALTER TABLE CONTEST MODIFY(CONTESTNAME VARCHAR2(1000));
ALTER TABLE CONTEST MODIFY(CONTESTFIELD VARCHAR2(1000));