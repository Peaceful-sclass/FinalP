...
--ALTER TABLE Team ADD CONSTRAINT FK_Team_TO_Team_1 FOREIGN KEY (TEAM_NO) REFERENCES Team (TEAM_NO);
...
ALTER TABLE TeamMember drop CONSTRAINT FK_Team_TO_TeamMember_1;
ALTER TABLE TeamMember ADD CONSTRAINT FK_Team_TO_TeamMember_1 FOREIGN KEY (TEAM_NO) REFERENCES Team (TEAM_NO) on delete cascade; 
